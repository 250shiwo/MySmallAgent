...
- [my_small_agent/skills/code_assistant/SKILL.md](file://my_small_agent/skills/code_assistant/SKILL.md)
...
- [docs/superpowers/plans/2026-07-01-skill-system.md](file://docs/superpowers/plans/2026-07-01-skill-system.md)
</cite>
...
D --> F[SKILL.md]
E --> G[SKILL.md]
H[prompt.py] --> I[system_prompt.md]
J[tools/] --> K[工具注册表]
J --> L[activate_skill.py]
J --> M[deactivate_skill.py]
N[tools/base.py] --> O[Tool 基类]
P[tests/] --> Q[test_prompt_manager.py]
P --> R[test_tools_skill.py]
P --> S[test_agent_skill.py]
P --> T[test_agent.py]
B --> C
C --> F
C --> G
...
R --> M
S --> C
T --> U[reset_session 测试]
V[cli.py] --> W[CLI 命令]
X[agent.py] --> Y[Agent 集成]
Z[tools/__init__.py] --> AA[工具注册表集成]
```
...
**工具偏好：**
- 文件操作：`read_file`、`write_file`、`tree`
- 代码搜索：`grep_search`、`find_file`
- 验证测试：`execute_shell`

**章节来源**
- [my_small_agent/skills/research/SKILL.md:1-31](file://my_small_agent/skills/research/SKILL.md#L1-L31)
- [my_small_agent/skills/code_assistant/SKILL.md:1-38](file://my_small_agent/skills/code_assistant/SKILL.md#L1-L38)
...
D[skills/code_assistant/SKILL.md]
E[prompt.py]
F[system_prompt.md]
end
subgraph "工具系统"
G[tools/activate_skill.py]
H[tools/deactivate_skill.py]
I[tools/base.py]
end
subgraph "核心系统"
J[cli.py]
...
subgraph "测试"
M[test_skills_registry.py]
N[test_prompt_manager.py]
O[test_tools_skill.py]
P[test_cli_skills.py]
Q[test_agent_skill.py]
R[test_agent.py]
end
A --> B
B --> C
...
- [tests/test_agent.py:304-374](file://tests/test_agent.py#L304-L374)
...
技能系统为 MySmallAgent 提供了强大的能力扩展框架，使得智能体能够适应各种复杂的任务场景，同时保持代码的整洁性和可维护性。通过预置的 Research 和 Code Assistant 技能，以及新增的 PromptManager、技能工具、CLI 集成、状态管理和测试体系，系统展示了如何将专业知识转化为可执行的技能模板，为未来的功能扩展奠定了坚实基础。